...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white pt-12 pb-20 sm:pt-16 sm:pb-28 border-b border-slate-800">
      ...
      <div className="absolute top-1/4 -right-20 w-[500px] h-[300px] bg-indigo-500/10 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            ...
            <div className="relative rounded-2xl bg-slate-800/80 border border-slate-700/80 p-2 sm:p-3 shadow-2xl shadow-blue-950/50 backdrop-blur-xl transition-all">
